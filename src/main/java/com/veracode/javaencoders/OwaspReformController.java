...
import com.veracode.javaencoders.tests.OwaspReform;
...
@Controller
public class OwaspReformController {

    @Autowired
    private TemplateEngine te;

    @RequestMapping(value = "/OwaspReformController/generateFile")
    public ModelAndView generateFile() {

        try {
            TestSet myTestSet = new TestSet();
            EncodingTester encodingTester = new EncodingTester(myTestSet, new OwaspReform());
    ...
    @RequestMapping(value = "/OwaspReformController/esegui")
    ...
    @RequestMapping(value = "/OwaspReformController/test")
