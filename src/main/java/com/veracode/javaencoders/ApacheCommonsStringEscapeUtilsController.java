...
import com.veracode.javaencoders.tests.ApacheCommonsStringEscapeUtils;
...
@Controller
public class ApacheCommonsStringEscapeUtilsController {

    @Autowired
    private TemplateEngine te;

    @RequestMapping(value = "/ApacheCommonsStringEscapeUtils/generateFile")
    public ModelAndView generateFile() {

        try {
            TestSet myTestSet = new TestSet();
            EncodingTester testerApacheCommonsStringUtils = new EncodingTester(myTestSet, new ApacheCommonsStringEscapeUtils());
    ...
    @RequestMapping(value = "/ApacheCommonsStringEscapeUtils/esegui")
    ...
    @RequestMapping(value = "/ApacheCommonsStringEscapeUtils/test")
