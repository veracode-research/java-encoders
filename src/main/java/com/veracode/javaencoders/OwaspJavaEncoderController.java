...
import com.veracode.javaencoders.tests.OwaspJavaEncoder;
...
@Controller
public class OwaspJavaEncoderController {

    @Autowired
    private TemplateEngine te;

    @RequestMapping(value = "/OwaspJavaEncoder/generateFile")
    public ModelAndView generateFile() {

        try {
            TestSet myTestSet = new TestSet();
            EncodingTester encodingTester = new EncodingTester(myTestSet, new OwaspJavaEncoder());
    ...
    @RequestMapping(value = "/OwaspJavaEncoder/esegui")
    ...
    @RequestMapping(value = "/OwaspJavaEncoder/test")
