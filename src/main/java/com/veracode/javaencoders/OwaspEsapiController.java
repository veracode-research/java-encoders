...
import com.veracode.javaencoders.tests.OwaspESAPI;
...
@Controller
public class OwaspEsapiController {

    @Autowired
    private TemplateEngine te;

    @RequestMapping(value = "/OwaspESAPIController/generateFile")
    public ModelAndView generateFile() {

        try {
            TestSet myTestSet = new TestSet();
            EncodingTester encodingTester = new EncodingTester(myTestSet, new OwaspESAPI());
    ...
    @RequestMapping(value = "/OwaspESAPIController/esegui")
    ...
    @RequestMapping(value = "/OwaspESAPIController/test")
