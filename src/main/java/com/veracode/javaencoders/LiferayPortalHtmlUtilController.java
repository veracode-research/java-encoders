...
import com.veracode.javaencoders.tests.LiferayPortalHtmlUtil;
...
@Controller
public class LiferayPortalHtmlUtilController {

    @Autowired
    private TemplateEngine te;

    @RequestMapping(value = "/LiferayPortalHtmlUtil/generateFile")
    public ModelAndView generateFile() {

        try {
            TestSet myTestSet = new TestSet();
            EncodingTester testerApacheCommonsStringUtils = new EncodingTester(myTestSet, new LiferayPortalHtmlUtil());
    ...
    @RequestMapping(value = "/LiferayPortalHtmlUtil/esegui")
    ...
    @RequestMapping(value = "/LiferayPortalHtmlUtil/test")
